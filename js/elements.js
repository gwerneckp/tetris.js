...
class LShape extends Block {
    ...
    stateOnePossible() {
        ...
        if (this.tetris.getBlock(this.points[this.aInd].x + 1, this.points[this.aInd].y + 1) == 1) {
            return false;
        }
        if (this.tetris.getBlock(this.points[this.aInd].x + 1, this.points[this.aInd].y + 2) == 1) {
            return false;
        }
        return true;
    }
    ...
    stateTwoPossible() {
        ...
        if (this.tetris.getBlock(this.points[this.aInd].x - 2, this.points[this.aInd].y + 1) == 1) {
            return false;
        }
        return true;
    }
